...
data_info = pandas.read_csv("./data/NUSW-NB15_features.csv", encoding = "ISO-8859-1", header=None).values
...
dataframe1 = pandas.read_csv("./data/UNSW-NB15_1.csv", header=None)
dataframe2 = pandas.read_csv("./data/UNSW-NB15_2.csv", header=None)
dataframe3 = pandas.read_csv("./data/UNSW-NB15_3.csv", header=None)
dataframe4 = pandas.read_csv("./data/UNSW-NB15_4.csv", header=None)
...
dataframe[48] = dataframe[48].apply(pandas.to_numeric, errors='coerce')
